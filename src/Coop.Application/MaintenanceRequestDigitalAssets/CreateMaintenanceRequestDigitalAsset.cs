...
public class CreateMaintenanceRequestDigitalAssetValidator : AbstractValidator<CreateMaintenanceRequestDigitalAssetRequest>
{
    public CreateMaintenanceRequestDigitalAssetValidator()
    {
