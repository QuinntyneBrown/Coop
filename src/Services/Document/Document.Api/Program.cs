...
using Document.Infrastructure.Data.Seeding;
    ...
    foreach (var arg in args)
    {
        switch (arg)
        {
            case "dropdb":
                ...
                Console.WriteLine("Document database dropped.");
                break;
            case "migratedb":
                await context.Database.MigrateAsync();
                Console.WriteLine("Document database migrated.");
                break;
            case "seeddb":
                DocumentSeedData.Seed(context, configuration);
                Console.WriteLine("Document database seeded.");
                break;
            case "stop":
                return;
        }
