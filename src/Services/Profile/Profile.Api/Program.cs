...
using Profile.Infrastructure.Data.Seeding;
using System.Text;
    ...
    foreach (var arg in args)
    {
        switch (arg)
        {
            case "dropdb":
                ...
                Console.WriteLine("Profile database dropped.");
                break;
            case "migratedb":
                await context.Database.MigrateAsync();
                Console.WriteLine("Profile database migrated.");
                break;
            case "seeddb":
                ProfileSeedData.Seed(context);
                Console.WriteLine("Profile database seeded.");
                break;
            case "stop":
                return;
        }
