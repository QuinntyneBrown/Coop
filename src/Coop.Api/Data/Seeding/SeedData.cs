...
namespace Coop.Api.Data
{
    public static class SeedData
    {
        ...
        public const string STAFF_MEMBER_AVATAR = "marie.webp";
        ...
        internal static class MemberConfiguration
        {
            public static void Seed(CoopDbContext context)
            {
                ...
                var avatar = context.DigitalAssets.Single(x => x.Name == "earl.webp");
        ...
        internal static class BoardMemberConfiguration
        {
            public static void Seed(CoopDbContext context)
            {
                ...
                var avatar = context.DigitalAssets.Single(x => x.Name == "natasha.webp");
        ...
        internal static class StaffMemeberConfiguration
        {
            public static void Seed(CoopDbContext context)
            {
                ...
                var avatar = context.DigitalAssets.Single(x => x.Name == "marie.webp");
