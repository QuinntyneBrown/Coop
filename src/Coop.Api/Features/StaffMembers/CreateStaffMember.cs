...
namespace Coop.Api.Features
{
    public class CreateStaffMember
    {
        ...
        public class Handler : IRequestHandler<Request, Response>
        {
            ...
            {
                var staffMember = new StaffMember(request.StaffMember.UserId.Value, request.StaffMember.JobTitle, request.StaffMember.Firstname, request.StaffMember.Lastname);
